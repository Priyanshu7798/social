...
const PostStats = ({ post,userId } : PostStatsProps) => {
    ...
    const {mutate : delteSavedPost , isPending : isDeletingSaved} = useDeleteSavedPost();
    ...
    const handleSavePost = (e : React.MouseEvent) => {
        ...
        if(savePostRecord){
            // clicked again delete the post
            setIsSaved(false);
            console.log(savePostRecord.$id);
            
            return delteSavedPost(savePostRecord.$id);
        }else{
            // save the post
